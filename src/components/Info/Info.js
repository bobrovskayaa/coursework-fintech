...
class Info extends Component {
  ...
  render() {
    return (
      <Wrapper
        header="О нас" 
        descr="Для компаний, которые разрабатывают software-обеспечение для нахождения ошибок наранних стадиях рахработки." 
        tag="about" wrpStyle='main'>
          ...
          <div id='box1' style={{display: 'none'}}>
            <Wrapper header='Проблема' wrpStyle='about'>
              <p>
                Согласно исследованию, проведенному в университете Кембриджа, в среднем разработчики тратят 50% рабочего времени на поиск и исправление ошибок, что стоит всей индустрии в целом 312 миллиардов долларов в год. При этом нельзя просто меньше заботиться об ошибках - даже один дефект способен привести к катастрофическим последствиям
              </p>
              <p>
